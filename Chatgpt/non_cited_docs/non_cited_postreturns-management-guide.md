[![Shippo](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/646bd3ac70ee08fca9869afe_shippo-logo-dark.svg)](https://goshippo.com/)

[Get started](https://apps.goshippo.com/join) [Contact sales](https://goshippo.com/contact/sales)

![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/661d50b365da0fb874fd050b_hamburger.svg)

[Return to Newsroom](https://goshippo.com/newsroom)

[Return to Main Blog](https://goshippo.com/blog)
...
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64aaaa64a4fd064ea74b174a_Hasan-Nabulsi-Head-Shot-scaled-1.jpeg)[By \\
\\
Hasan Nabulsi](https://goshippo.com/blog/returns-management-guide#authorbio)

![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64f108a070994c19e7c517e2_Returns-Management.png)
...
Returns management is the process in which businesses forecast returns, formulate [returns policies](https://goshippo.com/blog/return-policy-examples-real-businesses), communicate with [customers about their returns](https://goshippo.com/osh/how-to-handle-customer-returns), oversee return shipping, inspect returned items, and finally dump a damaged item or restock the item for resale later.

Because of this, managing returns can affect your sales team, customer service team, [warehousing/fulfillment](https://goshippo.com/blog/warehouses-vs-fulfillment-centers-vs-distribution-centers-choosing-whats-right-for-your-online-business) team, and finance team. It may possibly even affect your relationship with your manufacturers and suppliers of your products.
...
There are many reasons why someone might decide to return your products, but to boil it down to the most common reasons, we asked online shoppers why they return products in our [2022 Returns Report](https://try.goshippo.com/2022-returns-report/?_ga=2.96344607.2010094286.1670863588-1175152569.1629127394). Here are their answers:
...
Some of these responses are to be expected. For example, clothing has the highest rate of returns among all e-commerce segments, with [88% of shoppers reporting that they’ve returned clothing](https://www.statista.com/statistics/806122/most-returned-items-reverse-logistics-united-states/) they bought online in the past.
...
[Reverse logistics](https://goshippo.com/blog/the-ins-and-outs-of-reverse-logistics-for-e-commerce-businesses) is more concentrated on the process of receiving an item back from the customer. This can involve figuring out where customers go to drop off a return, which carrier is handling the return, and which warehouse or [fulfillment center](https://goshippo.com/shipping/fulfillment-center) they are taking that return to.
...
Be clear about accepting returns, including any requirements such as products being in their original [packaging](https://goshippo.com/blog/the-basics-cost-effective-ways-to-ship-large-packages), and specify how and when your store accepts returns. This helps manage returns and customer expectations.
...
**_Check out our_** [**_Return Policy_**](https://docs.goshippo.com/docs/shipments/returns/) **_to get a_** [**_custom_**](https://goshippo.com/shipping/customs) **_return policy for your business in minutes!_**
...
If your [inbound logistics](https://goshippo.com/shipping/inbound-logistics) has issues, it could result in faulty items being shipped during the [outbound logistics](https://goshippo.com/shipping/outbound-logistics) process, which can then resurface in the return logistics part of your business.
...
[Shippo has partners in this space](https://goshippo.com/partner-type/technology) and can recommend the best returns management software for your business. Simply contact your account manager or contact our customer success team with inquiries.

- Use The Correct Return Address For Each Item

While this might seem obvious for smaller merchants who receive orders, pack, ship, and accept returns at one location, it can be more complex for larger merchants. Those merchants may have [partnered with a 3PL](https://goshippo.com/partner-type/fulfillment) and have fulfillment centers located across the country or in multiple countries.
...
It’s because of this that you’ll want to make sure that customers who are inquiring about a return are given a [return shipping label](https://goshippo.com/shipping/return-shipping-labels) with the address of the closest fulfillment center to them on it. This will limit the cost of the [return label for you and/or your customer](https://goshippo.com/blog/how-to-send-prepaid-return-shipping-label-usps).

- Train Fulfillment Team On “Gatekeeping” Returned Items

You’ll want to make sure that your fulfillment team is aware of the return policy and properly inspects items before restocking. Any hiccup here could potentially result in multiple returns for the same item. You’ll also want to make sure that if there are any barcodes attached to your items that they are used in your [warehouse management system (WMS)](https://goshippo.com/shipping/warehouse-management-system-wms) to streamline the restocking process. This keeps certain [SKUs](https://goshippo.com/shipping/sku-stock-keeping-unit) together in your warehouse and helps expedite the time it takes to reship the product once a new order has been placed.
...
Returns are growing at an increasing rate across the board. According to the [National Retail Federation](https://nrf.com/media-center/press-releases/retail-returns-increased-761-billion-2021-result-overall-sales-growth), retailers just last year expected more than $761 billion in merchandise sold to be returned. Returns would make up an average of 16.6% of all retail sales.

The numbers get more staggering for e-commerce merchants since return rates for online products are [3-4 times higher](https://www.businesswire.com/news/home/20221026005029/en/Only-18-of-Retailers-Optimize-Return-Rates-for-Major-Product-Categories/) than return rates for in-store items. This is especially true for online orders, which often contribute to higher return rates due to factors like not being able to see or try products in person.

While some returns are due to buyer’s remorse and thus out of your control, there are some actions your business can take to [limit e-commerce returns](https://goshippo.com/blog/how-to-limit-ecommerce-returns). Those include:
...
- Establishing a clear [ecommerce return policy](https://goshippo.com/blog/return-policy-template-ecommerce) or returns policy to set customer expectations and reduce return rates
...
While it might not be that common, returns fraud could seriously affect your bottom line. In 2020 [retailers in the U.S. lost nearly $25.3 billion](https://nrf.com/media-center/press-releases/428-billion-merchandise-returned-2020) due to fraudulent returns. Because of this you'll want to consider them when shaping your returns management strategy.

To [stop fraudulent returns](https://goshippo.com/blog/how-to-protect-your-e-commerce-business-against-returns-fraud) in their tracks, you'll want to consider doing the following:
...
- Use order tracking and [signature confirmation](https://support.goshippo.com/hc/en-us/articles/204914695-How-to-Add-Signature-Confirmation-for-Package-Delivery) to guard against friendly fraud (i.e., a customer saying they never received an order and asking for a refund)
- Address bracketing head-on in your return policy. ( [Bracketing](https://www.businessinsider.com/bracketing-online-shopping-downsides-explained-2021-11) involves customers buying the same product in multiple sizes with the intent of only keeping one)

## **Managing Returns To Increase Sales**

There are ways in which you can use your returns management strategy to increase sales. Some common ways to [increase sales through returns](https://goshippo.com/blog/kover-guest-post-turn-your-return-policy-into-revenue) include:
...
In fact, 30% of consumers prefer to have the return label included, which makes sense given the that nearly one-third of the U.S. population does not own a printer. With Shippo, you can [print return labels at the same time as your shipping labels](https://goshippo.com/blog/provide-better-customer-experience-shipping-returns-with-shippo). Best of all, you won't be charged for the return label until it has been scanned by the carrier delivering the return.

To learn more about how consumers are approaching returns and what strategies your business can take to bolster its returns management strategy, be sure to check out our [On-Demand E-commerce Returns Webinar.](https://app.livestorm.co/shippo/what-todays-consumers-want-from-e-commerce-returns)

### **FAQ: E-commerce Returns Management**

**1\. What is ecommerce returns management?** Ecommerce returns management is the end-to-end process of handling returns—from forecasting and setting return policies, to communicating with customers, managing reverse shipping, inspecting items, and deciding whether to restock, recycle, or dispose of products. It touches sales, customer service, fulfillment, finance, and even supplier relationships.

**2\. How is returns management different from reverse logistics?** Reverse logistics focuses on the physical process of getting items back from customers (drop-off locations, carriers, and destination warehouses). Returns management includes reverse logistics **and** the strategic side: how returns impact inventory, margins, customer experience, and which partners or fulfillment methods you use.

**3\. What are some ways to reduce ecommerce returns?** You can limit returns by improving product detail and accuracy (high-quality photos, sizing charts, clear descriptions), preventing damage with proper packaging, avoiding order errors, promoting exchanges (e.g., offering a small discount on exchanges), and setting clear, easy-to-find return policies that manage expectations.

**4\. How can Shippo help make returns easier to manage?** With Shippo, you can generate return labels at the same time as shipping labels and only pay for them once they’re scanned by the carrier. This makes it easy to include return labels in the original shipment—something 30% of consumers prefer—and helps streamline the returns process for both your customers and your internal teams.

‍

Tags:

[Business & Operations](https://goshippo.com/blog-posts/tags/business-operations)

[Shipping Guides](https://goshippo.com/blog-posts/tags/shipping-guides)
...
- [Speed through your shipping](https://goshippo.com/products/shipping) with automations, bulk label purchase, and more.

- [Shipping Insurance](https://goshippo.com/insurance): Insure your packages at an affordable cost.

- [Shipping API](https://docs.goshippo.com/) for building your own shipping solution.


[Get started](https://apps.goshippo.com/join)
...
[![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/67041976457bb60176592a33_Instagram%20Icon.svg)](https://www.instagram.com/shipwithshippo/)[![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/670840bbc25119a79af6c07a_img-shippo-x-logo.svg)](https://x.com/shippo)[![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/670419967dbfdb251f27c652_LinkedIn%20Icon.svg)](https://www.linkedin.com/company/shippo)[![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/67041990b53d44ae0941fc7b_Facebook%20Icon.svg)](https://www.facebook.com/goshippo/)[![](https://cdn.prod.website-files.com/6462967bbf70fa5b5b227351/6704198b5b967cbdb58ba2d3_Youtube%20Icon.svg)](https://www.youtube.com/channel/UCU89bE91DIHAIyqeNfdRwLw)
...
SMB shipping\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/69d71abc04211ba0573919c4_shippo-quickbooks-integration-feature.webp)](https://goshippo.com/blog/shippo-quickbooks-integration)

[**How to Print Bulk Shipping Labels from a CSV in Shippo** \\
\\
All Things Shipping\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/69cecc0c41ad281b77c28266_how-to-import-orders-via-csv-feature.webp)](https://goshippo.com/blog/how-to-import-orders-via-csv)

[**Expedited Shipping: What It Is and Services Compared** \\
\\
All Things Shipping\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/69cc44fa53ec4cdbdc9b787b_expedited-shipping-what-it-is-and-services-compared-feature.webp)](https://goshippo.com/blog/expedited-shipping-what-it-is-and-services-compared)

[**The Complete Guide to International Shipping for Ecommerce** \\
\\
All Things Shipping\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/69cafe5fb4f6daeb51eeb87e_guide-international-shipping-feature.webp)](https://goshippo.com/blog/guide-international-shipping)
...
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64f10f225f4f0e03ca8a49f8_Brand-Packaging-banner-750x422-2%402x.png)](https://goshippo.com/blog/using-packaging-to-boost-your-brand-and-gain-a-competitive-advantage)

[**The Perfect Rate of Returns: What If a Higher Rate of Returns Were a Good Thing for Your Business?** \\
\\
E-commerce News and Insights\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64f10f11daa78a9abe05e782_Shippo-Returns-blog-banner-v1.png)](https://goshippo.com/blog/what-if-a-higher-rate-of-returns-were-a-good-thing-for-your-business)

[**Shipping to P.O. Boxes: Is it a No? Or Is it a Go?** \\
\\
All Things Shipping\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64f10f4eb93905e6421c5e0f_Shipping-PO-Boxes-banner-750x422-copy-2%402x.png)](https://goshippo.com/blog/post-office-box-pros-and-cons)

[**Brand Matters: How You Can Stand Out and Beat the Competition** \\
\\
E-commerce News and Insights\\
\\
![](https://cdn.prod.website-files.com/64700b7f349828a5b8dc81ab/64f10f5886e3215bcf6a7a85_BrandMatters-How-You-Can-StandOut-and-Beat-the-Competition_Banner.png)](https://goshippo.com/blog/how-you-can-stand-out-and-beat-the-competition)

a24733290240.cdn.optimizely.com

# a24733290240.cdn.optimizely.com is blocked
